...
meta() %>%
  ...
  meta_social(
    ...
    image = "https://github.com/franciscodalbertas/workshop_restauracao/blob/main/slides/figuras/coverimage.png",
...
### Francisco d’Albertas1*, Gerd Sparovek2, Luis-Fernando G. Pinto3, Camila Hohlenwerger1, Jean-Paul Metzger

1 - University of São Paulo, Department of Ecology, Institute of Biosciences, Rua do Matão, travessa 14, São Paulo, São Paulo 05508-090, Brazil.
2- Department of Soil Science, Luiz de Queiroz College of Agriculture, University of São Paulo, Piracicaba (SP), CP 9, CEP 13419-900, Brazil.
3 - Fundação SOS Mata Atlântica. Av. Paulista, 2073 - Horsa 1 - Conj. 1318, 01311-300, Bela Vista, São Paulo, São Paulo.
...
# O que encontramos :
### Foco nos cenários cumprimento LPVN
...
knitr::include_graphics("slides/figuras/results.png")
